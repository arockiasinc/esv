...
class PHPMailer
{
    ...
    * the HTML refers to using the `$cid` value in `img` tags, for example `<img src="cid:mylogo" alt="Logo">`.
     * Never use a user-supplied path to a file!
     *
     * @param string $path        Path to the attachment
    ...
    * $basedir is prepended when handling relative URLs, e.g. <img src="/images/a.webp" alt="Image"> and must not be empty
