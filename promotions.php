                        ...
                        <div class="bt_bb_column_content">
                            <header class="bt_bb_headline bt_bb_style_square bt_bb_size_huge bt_bb_superheadline">
                                <h1>
                                    ...
                                    <span class="bt_bb_headline_content"><span>Promotions</span></span>
                                </h1>
                            </header>
                        </div>
                        <!-- /rowItemContent -->
                                        ...
                                        <div class="bt_bb_column_content">
                                            <div class="bt_bb_column_content_inner">
                                                <header class="bt_bb_headline bt_bb_subheadline_font_weight_medium bt_bb_dash_none bt_bb_size_large bt_bb_subheadline bt_bb_align_inherit">
                                                    ...
                                                    At East Side Ventilation we have some promotions from time to time.<br>
                                                    Please make sure you subscribe to our mailing list to receive our offers when available.
                                                    </div>
                                                </header>
                                                        ...
                                                        <form action="#" method="post" class="wpcf7-form init" novalidate="novalidate" data-status="init">
                                                            ...
                                                            <div class="btContact">
                                                                ...
                                                                <div class="captcha_box">
                                                                    ...
                                                                    <span id="txtCaptchaDiv">Iy8cKU</span>
                                                                    <input type="hidden" id="txtCaptcha" value="Iy8cKU">
                                                                </div>
