...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testMultiplePlainFileAttachment()
    {
        ...
        if (!$this->Mail->addAttachment(realpath(self::INCLUDE_DIR . 'examples/images/phpmailer-2-2.webp'))) {
...
EOT;
        $this->Mail->addEmbeddedImage(
            realpath(self::INCLUDE_DIR . 'examples/images/phpmailer-2-2.webp'),
            'my-attach',
            'phpmailer.webp',
            'base64',
            'image/png'
...
EOT;
    ...
    public function testHTMLAttachment()
    {
        ...
        if (!$this->Mail->addAttachment(
            realpath(self::INCLUDE_DIR . 'examples/images/phpmailer_mini.webp'), 'phpmailer_mini.webp')
        ) {
            $this->assertTrue(false, $this->Mail->ErrorInfo);
            return;
        }
    ...
    public function testHTMLStringEmbedNoName()
    {
        ...
        if (!$this->Mail->addStringEmbeddedImage(
            file_get_contents(realpath(self::INCLUDE_DIR . 'examples/images/phpmailer_mini.webp')),
            md5('phpmailer_mini.webp').'@phpmailer.0',
    ...
    public function testHTMLMultiAttachment()
    {
        ...
        if (!$this->Mail->addAttachment(realpath(self::INCLUDE_DIR . 'examples/images/phpmailer_mini.webp'), 'phpmailer_mini.webp')) {
            $this->assertTrue(false, $this->Mail->ErrorInfo);
            return;
        }

        if (!$this->Mail->addAttachment(realpath(self::INCLUDE_DIR . 'examples/images/phpmailer-2-2.webp'), 'phpmailer.webp')) {
            $this->assertTrue(false, $this->Mail->ErrorInfo);
            return;
        }
