...
<section
    ...
    style="background-image: url('<?php echo $baseUrl; ?>/images/bg/ac-service-east-ventilation-winnipeg-2-2.webp'); background-position: 50% -320.04px;"
    data-parallax="0.8"
                        ...
                        <div class="bt_bb_column_content">
                            <header class="bt_bb_headline bt_bb_style_square bt_bb_size_huge bt_bb_superheadline">
                                <h1>
                                    ...
                                    <span class="bt_bb_headline_content"><span>Careers - Office Administrator </span></span>
                                </h1>
                            </header>
                        </div>
                        <!-- /rowItemContent -->
                                                ...
                                                <header class="bt_bb_headline bt_bb_subheadline_font_weight_medium bt_bb_dash_none bt_bb_size_large bt_bb_subheadline bt_bb_align_inherit">
                                                    <h3>
                                                        <span class="bt_bb_headline_content">
                                                            <span>
                                                                <a href="#" target="_self" title="Request  Service"><b>Office Administrator </b> - HVAC Company</a>
                                                            </span>
                                                        </span>
                                                    </h3>
                                                            ...
                                                            <div class="btContact">
                                                                ...
                                                                <div class="btContactRow">
                                                                    ...
                                                                    <span class="wpcf7-form-control-wrap your-address">
                                                                        <input type="text" name="your-address" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" />
                                                                    </span>
                                                                </div>
                                                                <div class="btContactRow">
